...
export const Integrations = () => {
    return (
        <div className=" max-w-projContainer m-auto my-28 flex flex-col items-center gap-14 lg:mx-5 sm:mx-3 sm:my-10">
            <div className=" text-center flex flex-col gap-3">
                <h2 className=" font-bold text-5xl sm:text-3xl">Over 300+ integrations</h2>
                <p className=" text-lg sm:text-base">Expand the capabilities of <span className=" font-bold"> Roooby </span> with hundreds of apps and integrations</p>
            </div>
            <div className=" sm:max-w-full sm:m-auto sm:flex sm:flex-row sm:overflow-hidden sm:overflow-x-scroll">

            <div className=" flex flex-nowrap gap-2 lg:flex-wrap xl:flex-wrap lg:max-w-projContainer xl:max-w-projContainer">

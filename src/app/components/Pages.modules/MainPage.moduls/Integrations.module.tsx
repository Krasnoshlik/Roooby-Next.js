...
export const Integrations = () => {
    return (
        <div className=" max-w-projContainer m-auto my-28 flex flex-col items-center gap-14 lg:mx-5 sm:mx-3">
            ...
            <div className=" flex flex-wrap gap-2 sm:items-center">
                <div className=" w-120 h-120 sm:w-20 sm:h-20 bg-white flex items-center justify-center rounded-xl">
                <Image src={Logo1} alt="Logo1" />
                </div>
                <div className=" w-288 h-120 sm:w-40 sm:h-20 bg-white flex items-center justify-center rounded-xl">
                ...
                <div className=" w-372 h-120 sm:w-40 sm:h-20 bg-white flex items-center justify-center rounded-xl">
